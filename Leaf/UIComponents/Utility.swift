...
//    appDelegate.fontPicker.showWindow(self)
  ...
  struct ShortCodeGenerator {
    ...
    private static let base62chars: ContiguousArray<CChar> = {
      return "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".utf8CString
    }()
    ...
    static func getCode(withBase base: UInt32 = maxBase, length: Int) -> String {
      ...
      for _ in 0..<length {
        ...
        code.append(String(base62chars[random]))
      }
      return code
    }
  }
