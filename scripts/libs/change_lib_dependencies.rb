...
def copy_and_change_dylib_dependencies(dependencies_folder)
  linked_files = Dir["#{`brew --prefix mpv`.chomp}/lib/*.dylib"]
  linked_files += Dir["#{`brew --prefix ffmpeg`.chomp}/lib/*.dylib"]
  linked_files += Dir["#{`brew --prefix libdvdnav`.chomp}/lib/*.dylib"]
  linked_files += Dir["#{`brew --prefix libdvdcss`.chomp}/lib/*.dylib"]
  linked_files += Dir["#{`brew --prefix libbluray`.chomp}/lib/*.dylib"]
  lib_folder = "#{dependencies_folder}/lib/"
